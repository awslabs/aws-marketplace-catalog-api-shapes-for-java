...
import com.amazonaws.services.marketplacecatalog.model.offer_1_0.ValidityTerm;
...
public class UpdateValidityTermsChangeDetail implements Serializable {
  ...
  private List<ValidityTerm> terms = new ArrayList<>();

  public UpdateValidityTermsChangeDetail() {
  }

  public UpdateValidityTermsChangeDetail terms(List<ValidityTerm> terms) {
    
    this.terms = terms;
    return this;
  }

  public UpdateValidityTermsChangeDetail addTermsItem(ValidityTerm termsItem) {
    if (this.terms == null) {
  ...
  **/
  ...
  public List<ValidityTerm> getTerms() {
    return terms;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TERMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTerms(List<ValidityTerm> terms) {
    this.terms = terms;
  }

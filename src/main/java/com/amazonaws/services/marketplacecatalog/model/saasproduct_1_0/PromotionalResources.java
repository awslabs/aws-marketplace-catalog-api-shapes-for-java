...
import com.amazonaws.services.marketplacecatalog.model.saasproduct_1_0.EntityAdditionalResource;
import com.amazonaws.services.marketplacecatalog.model.saasproduct_1_0.EntityPromotionalMedia;
import com.amazonaws.services.marketplacecatalog.model.saasproduct_1_0.Video;
...
public class PromotionalResources implements Serializable {
  ...
  private List<EntityAdditionalResource> additionalResources;

  public static final String JSON_PROPERTY_PROMOTIONAL_MEDIA = "PromotionalMedia";
  private List<EntityPromotionalMedia> promotionalMedia;
  ...
  **/
  ...
  public PromotionalResources additionalResources(List<EntityAdditionalResource> additionalResources) {
    
    this.additionalResources = additionalResources;
    return this;
  }

  public PromotionalResources addAdditionalResourcesItem(EntityAdditionalResource additionalResourcesItem) {
  ...
  **/
  ...
  public List<EntityAdditionalResource> getAdditionalResources() {
    return additionalResources;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ADDITIONAL_RESOURCES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdditionalResources(List<EntityAdditionalResource> additionalResources) {
    this.additionalResources = additionalResources;
  }


  public PromotionalResources promotionalMedia(List<EntityPromotionalMedia> promotionalMedia) {
    
    this.promotionalMedia = promotionalMedia;
    return this;
  }

  public PromotionalResources addPromotionalMediaItem(EntityPromotionalMedia promotionalMediaItem) {
  ...
  **/
  ...
  public List<EntityPromotionalMedia> getPromotionalMedia() {
    return promotionalMedia;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PROMOTIONAL_MEDIA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPromotionalMedia(List<EntityPromotionalMedia> promotionalMedia) {
    this.promotionalMedia = promotionalMedia;
  }
